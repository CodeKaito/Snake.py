...
def show_speed(choice, color, font, size):
    ...
    speed_surface = speed_font.render("Speed: " +str(speed), True, color)
    speed_rect = speed_surface.get_rect()
    if choice == 1:
        speed_rect.midtop = (frame_size_x/10, 30)
    else:
        speed_rect.midtop = (frame_size_x/2, frame_size_y/1.25)
...
while True:
    ...
    pygame.draw.rect(game_window,red, pygame.Rect(food_pos[0], food_pos[1], square_size, square_size -2))
    ...
    show_speed(1, white, 'consolas', 20)
